...
function sendRequest(answer_text, answer_guid) {
    ...
    request.post('https://us-central1-stuff-nzherald-poll-spamer.cloudfunctions.net/function-2', { json: payload }, (err, errors) => {
        if (errors && errors.pre == null && errors.pick == null && errors.post == null) {
